...
# alias gm="git merge"
alias gl="git log"
alias gds="git diff --diff-algorithm=histogram -p --staged --stat -- . ':!*_test.go'"
alias gd="git diff --diff-algorithm=histogram -p -- . ':!*_test.go'"
alias gda="git diff --diff-algorithm=histogram -p --stat"
alias gdsa="git diff --diff-algorithm=histogram -p --staged --stat"
