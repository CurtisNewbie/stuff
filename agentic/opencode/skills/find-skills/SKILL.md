...
- `npx skills add <package> -g` - Install a skill globally to `~/.agent/skills`
- `npx skills check` - Check for skill updates
- `npx skills update` - Update all installed skills

**Skill location:** Skills are installed globally to `~/.agent/skills/` (user-level, accessible across all projects)
...
This will install the skill to ~/.agent/skills/
...
**Important:** Always use the `-g` flag to install skills globally. Skills are installed to `~/.agent/skills/` (user-level), making them accessible across all projects and recognized by agents like OpenCode, Claude Code, etc.
