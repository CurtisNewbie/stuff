...
# Requirements:
1. Update AGENTS.md for importants things that must be remembered.
2. Once you have shown you plan to user, do not change to alternative solution unless user agree so, always confirm with the user. If the solution doesn't work, just say it, don't be "smart".
